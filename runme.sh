sudo apt update
sudo apt remove -y pcmanfm gnome-mpv audacious xfburn abiword gnumeric nautilus gdm remmina
...
sudo apt install -y lxterminal lxappearance miniupnpc thunderbird redshift redshift-gtk
